...
7.  * SFC /scannow` (Reparación de archivos de sistema).
8.  * Escaneo rápido de Microsoft Defender`.
9. * Reinicio: ** Es fundamental reiniciar el equipo para consolidar los cambios en el registro.
